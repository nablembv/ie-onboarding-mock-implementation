...
class BVUtility {
   ...
   *
   * @access public
   * @param string $bvstate
   *   - Value of the bvstate parameter.
   *
   ...
   * @access public
   * @param string ( $type)
   *   - content type or subject type which have to be checked.
   * @param string ( $typeType)
   *   - default 'ct', mark of type 'ct' - content type, 'st' - subject type.
   *
